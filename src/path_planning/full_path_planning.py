...
def compute_path(q_goal, plant, scene_graph, diagram_context, plant_context, meshcat, draw_path=False, downsample=False,
    ...
    print("Random goal positions (q_goal):", q_goal)
